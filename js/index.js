$(function(){
      ...
      // 存储接口
      function setpath(){
        sessionStorage.setItem("parth_path1","https://jx.parwix.com:4433/player/?url=")
        sessionStorage.setItem("parth_path2","https://jx.xmflv.com/?url=")
        sessionStorage.setItem("parth_path3","https://player.maqq.cn/?url=")
        sessionStorage.setItem("parth_path4","https://jx.aidouer.net/?url=")
      }
      setpath()
